...
alias lado="alias lzd='docker run --rm -it -v /var/run/docker.sock:/var/run/docker.sock -v ~/lazdydocker/config:/.config/jesseduffield/lazydocker lazyteam/lazydocker'"
